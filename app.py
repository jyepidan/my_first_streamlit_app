...
tooltip=[alt.Tooltip("x", title="X"),
                alt.Tooltip("y", title="Y")]).configure_axis(
    grid=False)
...
''' 
scatter = alt.Chart(df).mark_point().encode(x="x",
y= "y" , size='y', color='y', tooltip=[alt.Tooltip("x", title="X"),
...
- Added color based on y
- Added size based on y
- Added tooltip
- Changed opacity of visibility 
- Got rid of grid 
""")
